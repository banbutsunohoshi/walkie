...
Разработка проекта ведётся в отдельном репозитории на GitHub.

Репозиторий должен содержать:

- исходный код приложения
- JSON‑файлы с данными квестов и истории
- диаграммы (user flow и архитектурную схему) в виде изображений
